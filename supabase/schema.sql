...
-- 2. ENUMS
CREATE TYPE user_role_enum AS ENUM ('POINTEUR', 'PROPRIETAIRE', 'ADMINISTRATEUR');
CREATE TYPE tax_type_enum AS ENUM ('PER_TRUCK', 'PER_M3', 'PERCENTAGE');
CREATE TYPE expense_category_enum AS ENUM ('CARBURANT', 'REPARATION_ENGIN', 'SALAIRE_JOURNALIER', 'FRAIS_COMMUNAUTAIRES', 'AUTRE');
